    ...
    <header class="w-full top-0 bg-surface border-b border-outline-variant shadow-sm sticky z-50">
        <div class="flex justify-between items-center max-w-container-max mx-auto px-margin-desktop py-unit-md">
            ...
            <div class="flex items-center gap-unit-md">
                <a href="login.php" class="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-colors px-unit-md py-unit-sm">Sign In</a>
            </div>
        </div>
    </header>
        ...
        <section class="relative kinetic-bg py-unit-xl md:py-12 overflow-hidden flex items-center justify-center min-h-[calc(100vh-80px)]">
            <div class="max-w-md w-full mx-auto px-margin-mobile md:px-0">
                <div class="bg-surface p-unit-xl rounded-xl shadow-lg border border-outline-variant">
                    <h1 class="font-headline-lg text-headline-lg text-on-background mb-2">Create Account</h1>
                    ...
                    <?php if ($success_message): ?>
                        <div class="bg-secondary-container text-on-background px-unit-md py-unit-sm rounded-lg mb-unit-lg border border-primary font-body-sm">
                            <?php echo $success_message; ?>
                        </div>
                    <?php endif; ?>

                    <form method="POST" enctype="multipart/form-data" class="space-y-unit-md">
                        <div>
                            <label class="block font-label-md text-on-background mb-2">Full Name</label>
                        ...
                        <div>
                            <label class="block font-label-md text-on-background mb-2">Phone (Optional)</label>
                        ...
                        <div>
                            ...
                            <p class="text-on-surface-variant text-body-sm mt-1">Must contain uppercase, lowercase, and numbers</p>
                        </div>

                        <div>
                            <label class="block font-label-md text-on-background mb-2">Account Type</label>
                        ...
                        <div>
                            <label class="block font-label-md text-on-background mb-2">Profile Photo (Optional)</label>
                    ...
                    <p class="text-center text-on-surface-variant font-body-sm mt-unit-lg">
                        ...
                        <a href="login.php" class="text-primary font-label-md hover:underline">Sign In</a>
                    </p>
                </div>
            </div>
